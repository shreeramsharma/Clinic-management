            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Qualification </h4> </div>
                ...
                <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="AddDrQualificationAction.jsp" method="POST">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="qualification" placeholder="Enter Qualification Name...." class="form-control form-control-line"> </div>
                                </div>
								<div class="form-group">
                                    <label class="col-md-12">Institute</label>
                                    <div class="col-md-12">
                                        <input type="text" name="institute" placeholder="Enter institute...." class="form-control form-control-line"> </div>
                                </div>
                                </div><br>
                                <div class="form-group">
