            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Patient Application </h4> </div>
                ...
                <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="AddPatientAction.jsp" method="POST">
                                <div class="form-group">
								<input type="hidden" name="dr_id" value="<%= seid%>">
                                    <label class="col-md-12">First Name</label>
                                    <div class="col-md-12">
									
                                        <input type="text" name="firstname" placeholder="Enter First Name...." class="form-control form-control-line"> </div>
                                </div>
								<div class="form-group">
                                    <label class="col-md-12">Last Name</label>
                                    <div class="col-md-12">
                                        <input type="text" name="lastname" placeholder="Enter Last Name...." class="form-control form-control-line"> </div>
                                </div>
								 <div class="form-group">
											  ...
											  <div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="email" name="email" placeholder="Enter Email..." class="form-control form-control-line" name="example-email" id="example-email"> </div>
												</div>
												 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="contact" pattern="[7-9]{1}[0-9]{9}" placeholder="Enter number...." class="form-control form-control-line"> </div>
                                </div><br>
								<div class="btn-group">
                                <div class="form-group">
