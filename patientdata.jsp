            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Patient Records </h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        
                            <a href="PatientForm.jsp"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Add More Patient</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- .row -->
		    </header>
			 <div class="white-box table-responsive"><!-- /header -->
...
Connection myConn = DriverManager.getConnection(url,user,pass);
Statement myStmt = myConn.createStatement();
String query = "Select * from patient where dr_id='"+seid+"' ";
ResultSet rs = myStmt.executeQuery(query);
while(rs.next()){
...
%>
                      <tr>
                        <td ><!---<a href="updateform.jsp?update_id=<%= id %>">----><%= firstname %></td></a>
                        <td><%= lastname %></td>
                        <td><%= dateofbirth %></td>
                        <td><%= gender %></td>
                        <td><%= age %></td>
                        ...
                        <td><%= address %></td>
                        <td><%= contact %></td>
						<td><a href="deletepatient.jsp?delete_id=<%= id %>"><button  class="btn btn-danger" onclick="return confirm('Are you sure to delete ?');"><i class="fa fa-trash"></i></button></a>&ensp;
						<a href="patientupdateform.jsp?update_id=<%= id %>"><button  class="btn btn-primary" >	<i class="fa fa-pencil"></i></button></a>
